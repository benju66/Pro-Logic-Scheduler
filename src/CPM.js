...
export class CPM {
    ...
    static calculate(tasks, calendar, options = {}) {
        ...
        // Create helper functions with closure over tasks
        const isParent = options.isParent || ((id) => tasks.some(t => t.parentId === id));
        ...
        return {
            ...
            stats: {
                ...
                criticalCount: tasks.filter(t => t._isCritical && !isParent(t.id)).length,
            },
        };
    }
